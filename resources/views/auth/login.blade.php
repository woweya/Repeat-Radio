<x-layout>
    ...
    <div class="flex flex-col justify-center items-center w-full mt-10 mb-10" style="position:relative; overflow:hidden;">
        @if (session()->has('error') || session()->has('message') || $errors->any())
        <h2 class="text-rose-600 p-3 mb-5 bg-rose-100 text-center text-lg font-bold" style="border-radius: 10px;">
            {{ session()->get('error') ?? (session()->get('message') ?? $errors->first()) }}</h2>
    @endif
        <div class="form-container" data-aos="zoom-in" data-aos-duration="1000" data-aos-once="true">
            ...
            <div class="social-message">
                ...
                <a href="{{ route('auth.discord', ['client_id' => env('DISCORD_CLIENT_ID')]) }}">
                    <svg width="30px" height="30px" viewBox="0 -28.5 256 256" version="1.1"
            ...
            <p class="signup mt-2">Don't have an account?
