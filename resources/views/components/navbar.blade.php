<nav class="px-10 py-3" id="navbar"{{--  wire:ignore --}}>
    <div class="left-side-nav ">
        <div class="flex flex-row justify-center items-center">
            <img src="{{ Storage::url('immagini/Repeat-Radio-R1-09.png') }}" style="width:30px; " class="p-0 mr-4"
                alt="">
    ...
    <ul class="flex flex-row gap-4 middle-ul">
        ...
        <li><a href="{{ route('about') }}">Radio</a></li>
        @auth
        ...
        @auth
            <ul class="flex flex-row gap-4">
                <a href="{{ route('user', ['id' => Auth::user()->id]) }}"
                    class="text-[color:var(--quinary-color)] user-settings">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="var(--quinary-color)" class="w-6 h-6">
