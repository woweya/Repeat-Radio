        ...
        <form id="form-role"  method="POST" wire:submit.prevent="createRole" class="flex flex-col w-3/4" style="">
            ...
            <div class="bg-form w-full flex flex-col justify-center items-center p-5" style=" border-radius: 10px;">
                ...
                <div class="flex flex-col left-side gap-5" style="width: 50%;">
                    ...
                    <div class="colors flex-col items-start justify-start mt-1 mb-5 gap-3">
                        <div>
                ...
                <div class="flex flex-col right-side gap-5" style="width:50%;">
                    ...
                    <h1 class="text-3xl text-[color:var(--quaternary-color)] font-extrabold mb-2 mt-5 text-end">Guests</h1>
                    ...
                    <div class="flex flex-col gap-2">
                        <div class="form-group flex flex-col " style="width: 100%">
                            ...
                            <div class="flex items-center w-full justify-center relative mb-6">
                                <input class="w-full mt-2" style="border-radius: 5px" name="guests" type="text"
                                    class="form-control" id="guests" placeholder="Guests users...">
                        ...
                        <div class="form-group flex flex-col" style="width: 100%">
                            <h1 class=" text-[color:var(--quaternary-color)] font-extrabold text-2xl mb-2">Guests</h1>
                            <div class="flex">
                    ...
                    <div class="hero-icons flex-col mt-5">
                        ...
                        <button data-popover-target="popover-icon-2" type="button" class="icon-role" id="icon-2"
                            wire:click="selectIcon('articleWriter')">
                        ...
                        <button data-popover-target="popover-icon-3" type="button" class="icon-role" id="icon-3"
                            wire:click="selectIcon('radioPresenter')">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="var(--quaternary-color)" class="w-9 h-9">
                                <path fill-rule="evenodd"
                        ...
                        <button data-popover-target="popover-icon-4" type="button" class="icon-role" id="icon-4"
                            wire:click="selectIcon('technicalDirector')">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="var(--quaternary-color)" class="w-9 h-9">
                        ...
                        <button data-popover-target="popover-icon-5" type="button" class="icon-role" id="icon-5"
                            wire:click="selectIcon('programDirector')">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="var(--quaternary-color)" class="w-9 h-9">
                                <path fill-rule="evenodd"
                        ...
                        <button data-popover-target="popover-icon-6" type="button" class="icon-role" id="icon-6"
                            wire:click="selectIcon('presenter')">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="var(--quaternary-color)" class="w-9 h-9">
                                <path fill-rule="evenodd"
                        ...
                        <button data-popover-target="popover-icon-7" type="button" class="icon-role" id="icon-7"
                            wire:click="selectIcon('radioDirector')">
                            <svg class="w-9 h-9 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                fill="none" viewBox="0 0 24 24">
                                <path stroke="var(--quaternary-color)" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="2"
                        ...
                        <button data-popover-target="popover-icon-8" type="button" class="icon-role" id="icon-8"
                            wire:click="selectIcon('articleDirector')">
                        ...
                        <button data-popover-target="popover-icon-9" type="button" class="icon-role" id="icon-9"
                            wire:click="selectIcon('moderator')">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="var(--quaternary-color)" class="w-9 h-9">
                                <path fill-rule="evenodd"
                        ...
                        <button data-popover-target="popover-icon-10" type="button" class="icon-role"
                            ...
                            <svg class="w-9 h-9 " fill="var(--quaternary-color)" aria-hidden="true" version="1.1"
            ...
            <div class="flex flex-col w-3/4 justify-center items-center py-5 rounded" style="border: 2px solid #2E143E; border-bottom:none; border-top:none">
            ...
            <textarea id="description" name="description" wire:model="description" rows="4" class="block p-2.5 w-2/3 text-sm text-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..." style="background-color:#2f2f2f; border-color:var(--purple-color)"></textarea>

            </div>

            <div class="flex gap-10 w-3/4 justify-center items-center py-5" style="border: 2px solid #2E143E; border-top:none">
                <button class="bg-violet-800 hover:bg-violet-900 text-white font-bold py-2 px-4 rounded">Save</button>
...
<script>
    ...
    document.addEventListener('livewire:navigated', function() {
        let icons = document.querySelector('.hero-icons');
        ...
        document.addEventListener('click', (event) => {
            ...
            if (!event.target.classList.contains('color')) {
                // Se l'elemento cliccato non ha la classe 'color'
                icons.style.cursor = 'not-allowed';
                icons.style.opacity = '0.5';
                icons.style.pointerEvents = 'none';
            } else {
                // Se l'elemento cliccato ha la classe 'color'
