                        ...
                        <div class="audio green-audio-player">
                            ...
                            <div class="love p-2">
                                <div style="z-index:9999;">
                                    <svg wire:click="likeSong" xmlns="http://www.w3.org/2000/svg" id="love" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                    stroke="var(--quaternary-color)" style="position: absolute; top: 30px; right: 10px;" class="w-5 h-5 {{$isLiked ? 'active' : ''}}">
                                    <path stroke-linecap="round" stroke-linejoin="round"
