<div id="last-played" wire:poll.5000s class="">
    @if ($error)
        <div class="card-highlight flex flex-row" style="min-width: 65%; width: 80%; position: relative">
            <div class="card mt-5 px-3 py-2 flex flex-row justify-start items-center w-full"
                ...
                <div class="card-body ml-5 w-2/3"
                    style="position: relative; height: 100%; max-height: 184px; min-height: 184px">
    ...
    @else
        @foreach ($lastThreeSongs as $songs)
            @if ($loop->first)
                <div class="card-highlight flex"
                    style="min-width: 65%; width: 80%; position: relative; flex-direction: row!important">
                    <div class="card mt-5 px-3 py-2 flex flex-nowrap justify-start items-start w-full"
                        ...
                        <img id="songImage" width="180" height="100" class="rounded" src="{{ $songs['art'] }}"
                            alt="">
                        <div class="card-body ml-5 flex flex-col items-start justify-center"
                            style="position: relative; height: 100%; max-height: 184px; min-height: 184px">
                            <p class="text-[color:var(--quinary-color) text-md font-bold" style="top: 0%">34 likes</p>
                            <p id="songTitle" class="text-[color:var(--quaternary-color)] text-2xl font-bold">
                        ...
                        <div class="card-body ml-3 w-full" style="z-index: 1">
                            <div class="flex">
                                <div class="left-side-card-body" style="width: 85%;">
                                    <h5 class="text-[color:var(--quaternary-color)] font-bold w-full">
                                        {{ $songs['title'] }}</h5>
