    ...
    <nav class="px-10 py-3" id="navbar" wire:ignore>
        ...
        @auth
        <ul class="flex flex-row gap-4">
            <a href="{{-- {{ route('user', ['id' => Auth::user()->id])}} --}}" wire:click.prevent="loadUser" class="text-[color:var(--quinary-color)] user-settings"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="var(--quinary-color)" class="w-6 h-6">
