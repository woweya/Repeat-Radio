                ...
                <div class="header-infos flex justify-between mt-20 clearfix">
                    ...
                    <div class="social-links">
                        <div class="flex gap-2 py-2">
                            <a href=""><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50"
                            ...
                            <a href=""><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48"
                                ...
                                <div class="flex flex-col gap-5 justify-start items-start">
                                    <label
                                        ...
                                        <span
                                            ...
                                            me box</span>
                                        @if ($AboutMe === true)
                                            <input type="checkbox" wire:model.change="AboutMe" class="sr-only peer"
                                                checked>
                                        @else
                                            <input type="checkbox" wire:model.change="AboutMe" class="sr-only peer">
                                        @endif
            ...
            <section class="section-about-me-box relative">
                ...
                <div id="expandable-content"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="white" class="size-6 cursor-pointer hover:scale-110 absolute right-3 top-3"
                        id="changeaboutme">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L6.832 19.82a4.5 4.5 0 0 1-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 0 1 1.13-1.897L16.863 4.487Zm0 0L19.5 7.125" />
                    </svg>
        ...
        <div class="top-songs w-full py-5 flex flex-col gap-2 relative">
            ...
            <div class="card w-full flex justify-start items-center">
                <div class="card-header">
                    <img src="https://www.ideabit.com/album/foto_full/formato-immagini-webp_710.jpg" alt="" />
                </div>
